...
public class CaAlumni {
    ...
    public CaAlumni(Integer id, Integer partentId, String name, String description, String rule, String organization, String leaderDesc, String tel, String wx, String qq, String webSite, Integer type, Date createTime, Date updateTime) {
        this.id = id;
