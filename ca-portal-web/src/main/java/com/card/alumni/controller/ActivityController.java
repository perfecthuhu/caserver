...
public class ActivityController {
    ...
    @PostMapping("/page/my")
    @ApiOperation(value = "分页查询我的活动列表", notes = "分页查询我的活动列表")
    public UnifiedResult<PageData<ActivityModel>> pageMyByRequest(@RequestBody ActivityQueryRequest request) throws Exception {

        LOGGER.info("{} page my activities by request. request = {}", LOGGER_PREFIX, request, RequestUtil.getUserId().toString());
