...
public class LikeServiceImpl implements LikeService {
    ...
    @Override
    public boolean hasLike(Integer tenantId, Long targetId, Integer userId) {
        CaLike like = findByTenantIdAndTargetIdAndUserId(tenantId, targetId, userId);
        return Objects.nonNull(like);
    }

    @Override
    public Map<Long, Boolean> mapHasLike(Integer tenantId, List<Long> targetIds, Integer userId) {
        checkTenant(tenantId);
        if (CollectionUtils.isEmpty(targetIds)) {
            return Maps.newHashMap();
        }
