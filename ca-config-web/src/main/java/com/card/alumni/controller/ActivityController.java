...
public class ActivityController {
    ...
    public UnifiedResult<List<UserModel>> listUserByActivityId(@PathVariable("id") Integer id) throws Exception {
    ...
    @ApiOperation(value = "让用户加入活动", notes = "让用户加入活动")
    public UnifiedResult joinActivity(@PathVariable("id") Integer id,
                                      @PathVariable("userId") Integer userId) throws Exception {

        LOGGER.info("{} join activity. activityId = {}, userId = {}, operator = {}", LOGGER_PREFIX, id, userId, RequestUtil.getUserId().toString());
        try {
    ...
    @PutMapping("/{id}/exit/{userId}")
    @ApiOperation(value = "退出活动", notes = "退出活动")
    public UnifiedResult exitActivity(@PathVariable("id") Integer id,
                                      @PathVariable("userId") Integer userId) throws Exception {

        LOGGER.info("{} exit activity. activityId = {}, userId = {}, operator = {}", LOGGER_PREFIX, id, userId, RequestUtil.getUserId().toString());
        try {
            activityService.exitActivity(id, userId);
            return UnifiedResult.success();
        } catch (CaException e) {
